...
//This page adds a new band to  & adds a member to an existing band
...
if((!isset($_SESSION["logged"])) && !$_SESSION["logged"])
{
    ...
    if (mysql_num_rows($get_info_res)> 0)
    {
        ...
        while ($person_info = mysql_fetch_array($get_info_res))
        {
            ...
            $display_block .= "<strong>Status: </strong>$person_status<br /><br /><strong>Comments: </strong>$person_comment<br /><br /></div>";
            }
        ...
        } else
        {
         ...
         while($recs = mysql_fetch_array($get_list_res))
         {
            ...
            //link to create a new band record
   ...
   //display person info
    if (mysql_num_rows($get_info_res)> 0)
    {
        ...
        while ($person_info = mysql_fetch_array($get_info_res))
        {
            ...
            $display_block .= "<table width=\"300\" border=\"0\" cellspacing=\"5\" cellpadding=\"5\"><tr><td>$fname $lname<br />$phone<br />";
            $display_block .= "<a href=\"mailto:$email\">$email</a><br /><br />";
            $display_block .= "<strong><emStatus: </strong>$person_status<br /><br /><strong>Comments: </strong>$person_comment<br /><br />";
            }
        ...
        } else
        {
         ...
         while($recs = mysql_fetch_array($get_list_res))
         {
            ...
            <input type=\"hidden\" name=\"person_id\" value=\"$person_id\">
            <input type=\"hidden\" name=\"op\" value=\"add_band_member\">
            <input type=\"submit\" name=\"submit\" value=\"Add band membership\"></form>";

            $display_block .= "<a href=\"create_new_band_on_res.php?reservation_id=$reservation_id&repeat_id=$repeat_id&return_url=$return_url&person_id=$person_id\">Create a new band record</a></td></tr></table></div>";
