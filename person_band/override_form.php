...
if((!isset($_SESSION["logged"])) && !$_SESSION["logged"])
{
 ...
 //connect to the db
    ...
    $display_block .= "<div id=\"override_links\"><a href=\"add_person.php?reservation_id=$reservation_id&repeat_id=$repeat_id&return_url=$return_url\">Select a different person</a> | <a href=\"cancel_reservation.php?reservation_id=$reservation_id\">Cancel this reservation</a></div>";
    ...
    $display_block .= "<form method=\"post\" action=\"override.php\" onsubmit=\"return checkform(this);\">
    <table border=\"0\">
