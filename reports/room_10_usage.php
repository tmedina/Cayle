...
/*
 * room usage - room 10
 * with actual and scheduled start and end times and actual and scheduled duration
 * 20090419 beth
 */
...
?>
  ...
  <body>
  <h2>Usage Report - Room 10 <? echo $start_date ?> to <? echo $end_date?></h2>
    <div>
