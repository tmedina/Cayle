...
//This report shows all off-site equipment reservations for a person including cancellations
//
//TO DO:
// - form validation
...
if (!isset($_POST['run_report']))
{
    // view the drop down list of active person record names & phone numbers available
     ...
     if (mysql_num_rows($get_list_res) <1)
     {
         ...
         $display_block .= "<h2 align=\"left\">Off-site equipment reservations by person</h2>";
...
{           include("../includes/dbconnect.inc");
           ...
           if (mysql_num_rows($get_reservations_res)> 0)
            {
                $display_block .= "<h2 align=\"left\">Off-site equipment reservations for " . $fname . " " . $lname .  " from " . $req_start_date . " to " . $req_end_date    . "</h2>";
                $display_block .= "<div id=\"links_report_new\"><a href=\"../admin/index.php\">Back to reports index</a> | <a href=\"equip_only_res_by_person.php\">Select a different person</a></div>";
...

            {
                $display_block .= "<h2 align=\"left\">Off-site equipment reservations for " . $fname . " " . $lname .  " from " . $req_start_date . " to " . $req_end_date    . "</h2>";
                $display_block .= "<div id=\"links_report_new\"><a href=\"../admin/index.php\">Back to reports index</a> | <a href=\"equip_only_res_by_person.php\">Select a different person</a></div>";
                $display_block .= "<div id=\"text\" align=\"left\"><p>No off-site equipment reservations for this person</p></div>";
            }
            }
           ...
           if (mysql_num_rows($get_reservations_res)> 0)
            {
                $display_block .= "<h2 align=\"left\">Off-site equipment reservations for " . $fname . " " . $lname .  " <span style=\"color:#FF0000\">(inactive)</span> from " . $req_start_date . " to " . $req_end_date    . "</h2>";
                $display_block .= "<div id=\"links_report_new\"><a href=\"../admin/index.php\">Back to reports index</a> | <a href=\"equip_only_res_by_person.php\">Select a different person</a></div>";
                $display_block .= "<form method=\"post\" action=\"$_SERVER[PHP_SELF]\">";
                $display_block .= "<div id=\"text\" align=\"left\"><table border=\"1\" cellspacing=\"5\" cellpadding=\"5\">";
                $display_block .= "<th>Reservation id</th><th>Start time</th><th>End time</th><th>Equipment name</th><th>Status</th><th>Cancelled?</th>";
...
<html>
    <head>
    <title>Report: off-site equipment reservations by person</title>
