...
$sql = "select mc.name as misc_charge_name, mct.name as misc_charge_type, rt.comment as charge_comment, 
                rt.updated_at as charge_date, eq.equip_serial_number as serial_num
                from reservation_transaction rt, misc_charge mc, misc_charge_type mct, equipment eq
...
?>
  ...
  <body>
  <h2>Miscellaneous Transactions - Inspection Results <? echo $start_date ?> to <? echo $end_date?></h2>
    <div>
...
// create query
$query = "select mc.name as misc_charge_name, mct.name as misc_charge_type, rt.comment as charge_comment, eq.equip_serial_number as serial_num,
...
{
    echo "<table border='1'>";
    echo "<th>Inspection Results</th>";
    echo "<th>Inspection Comments</th>";
    echo "<th>Equipment Serial Number</th>";
...
$sql = "select mc.name as misc_charge_name, mct.name as misc_charge_type, rt.comment as charge_comment, eq.equip_serial_number as serial_num,
                rt.updated_at as charge_date
                from reservation_transaction rt, misc_charge mc, misc_charge_type mct, equipment eq
                where mct.id = mc.misc_charge_type_id
                and mc.id = rt.misc_charge_id
