...
//This page show a person record from the drop down menu
...
//view a selected person record
    ...
    $get_info = "SELECT * FROM person, states, person_status WHERE states.id = person.state_id AND person_status.id = person.person_status_id AND person.is_active=1 AND person.id = $_POST[sel_id]";
