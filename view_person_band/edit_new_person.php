...
// edit newly created person record
if (!isset($_POST['edit']))    
{
        //define variables
        $fname = $_GET['fname'];
      ...
      <tr><td valign=\"top\">Comment: </td><td><textarea rows=\"3\" cols=\"38\" name=\"person_comment\">$person_comment</textarea></td></tr>";
...
<html>
    ...
    <!--
    Form validation - makes sure fname, lname & phone are not empty
    -->
