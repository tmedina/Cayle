...
?>
div#dwm_header {width: 25%; float: left; margin-top: 1.0em; margin-bottom: 0.5em}
...
div.date_nav    {float: left;  width: 75%; margin-top: 0.5em; margin-bottom: 0.5em; font-weight: bold}
div.date_before {float: left;  width: 33%; text-align: right}
div.date_now    {float: left;  width: 33%; text-align: center}
div.date_after  {float: right; width: 33%; text-align: left}

table.dwm_main {float:right; width: 75%; border-spacing: 0; border-collapse: separate;
