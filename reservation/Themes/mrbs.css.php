...
//Commented out by Hallie on 4/15/09
//a:link    {color: $anchor_link_color;    text-decoration: none; font-weight: bold}
//a:visited {color: $anchor_link_color; text-decoration: none; font-weight: bold}
//a:hover   {color: $anchor_link_color;   text-decoration: none; font-weight: bold}

//Added by Hallie on 4/15/09
...
a:link {color:#7C3B36; text-decoration:none; font-weight: bold;}

a:visited {color:#7C3B36; text-decoration:none;font-weight: bold;}
...
a.link2:hover {color:#b2c5dc; text-decoration:none;}
...
//end code added by Hallie on 4/15/09
...
?>
div#dwm_header {width: 22%; float: left; margin-top: 1.0em; margin-bottom: 0.5em}
div#dwm_areas  {float: left; margin-right: 2.0em}
div#dwm_rooms  {float: left; margin-right: 2.0em}
div#dwm_legend {float: left; margin-right: 2.0em}
div#dwm_date_selector {margin-right: 0}
...
div.date_nav    {float: left;  width: 78%; margin-top: 0.5em; margin-bottom: 0.5em; font-weight: bold}
div.date_before {float: left;  width: 33%; text-align: right}
div.date_now    {float: left;  width: 33%; text-align: center}
div.date_after  {float: right; width: 33%; text-align: left}

table.dwm_main {float:right; width: 78%; border-spacing: 0; border-collapse: separate;
...
div#cal_last {float: left; margin-left: 1.0em}
...
div#view_options {width: 100%; text-align: center;}

div#title_line {width: 100%;}
div#title_center {text-align: center;}
div#title_right {text-align: right;}
