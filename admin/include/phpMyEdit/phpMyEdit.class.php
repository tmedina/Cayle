 ...
 * Date         Who      What
 ***********************************************************************************
 * 10-11-2006   wilson   Added tblName, main_menu_id and sub_menu_id to url 
		...
		for ($k = 0; $k < $this->num_fds; $k++) {
			...
			if (! $this->fdd[$fd]['sort'] || $this->password($fd)) {
				...
				echo htmlspecialchars($this->page_name.'?'.$this->cgi['prefix']['sys'].'fm'.'=0'
						...
						.'&tblName='.$this->tb                        //wilson 10-11-2006
						.'&tblLabel='.$_REQUEST['tblLabel']          //wilson 10-11-2006
						.'&main_menu_id='.$_REQUEST['main_menu_id']   //wilson 10-11-2006
						.'&sub_menu_id='.$_REQUEST['sub_menu_id']     //wilson 10-11-2006
