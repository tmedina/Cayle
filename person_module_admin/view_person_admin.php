...
//This page shows person records
...
if((!isset($_SESSION["logged"])) && !$_SESSION["logged"])
{
    ...
    //connect to the database and the functions.inc file
    ...
    //get person info
    $get_info = "SELECT person.id, fname, lname, address, city, state_name, zip, phone, email, person_status, person_comment, person.is_active, user_name FROM person, states, person_status WHERE states.id = person.state_id AND person_status.id = person.person_status_id AND person.id = $_POST[sel_id]";
    ...
    if (mysql_num_rows($get_info_res)> 0)
    {
        ...
        while ($person_info = mysql_fetch_array($get_info_res))
        {
            ...
            //if record is active and has an addresss do this
            ...
            $display_block .="<div id=\"text\" align=\"left\"><h3 align=\"left\">Record for $fname $lname - active</h3>";
            ...
            $display_block .= "<strong>Comments: </strong>$person_comment";
            $display_block .= "<br /><br /><a href=\"band.php\">Add band membership</a> | <a href=\"deactivate_person.php?person_id=$person_id\" onclick=\"return confirm('Are you sure you want to deactivate this record?')\">Deactivate</a> | <a href=\"edit.php?cmd=edit&id=$person_id\">Edit</a></td></tr></table></div>";
            }
            ...
            {
            $display_block .= "<div id=\"links\"><a href=\"band.php\">View/create band records</a> | <a href=\"create_new_person.php\">Create a new person record</a> | <a href=\"index.php\">Select a different person</a></div>";
            $display_block .= "<div id=\"text\"><h3 align=\"left\">Record for $fname $lname</h3>";
            ...
            {
            $display_block .= "<div id=\"links\"><a href=\"band.php\">View/create band records</a> | <a href=\"create_new_person.php\">Create a new person record</a> | <a href=\"index.php\">Select a different person</a></div>";
            $display_block .="<div id=\"text\"><h3 align=\"left\" style=\"color:#FF0000\">Record for $fname $lname - inactive</h3>";
            $display_block .= "<table width=\"300\" border=\"0\" cellspacing=\"5\" cellpadding=\"5\"><tr><td>$fname $lname <br />$address<br />$city $state_name $zip<br />$phone<br />";
            $display_block .= "<a href=\"mailto:$email\">$email</a><br /><br />";
            $display_block .= "<strong>Status: </strong>$person_status<br /><br />";
            $display_block .= "<strong>User name: </strong>" . $user_name . "<br /><br />";
            $display_block .= "<strong>Comments: </strong>$person_comment";
            $display_block .= "<br /><br /><a href=\"activate_person.php?person_id=$person_id\" onclick=\"return confirm('Are you sure you want to activate this record?')\">Activate record</a> | <a href=\"edit.php?cmd=edit&id=$person_id\">Edit</a></td></tr></table>";
