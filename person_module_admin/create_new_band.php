...
//This pages creates a new band record
 ...
 if (!isset($_POST['submit_band']))
    {
            ...
            Band name: <br /><input type=\"text\" size=50 name=\"band_name\" /> <strong>*</strong><br />
  ...
  if (isset($_POST['submit_band']))
         ...
         while ($band_info = mysql_fetch_array($check_for_dups_res))
        {
            ...
            $display_block .= "<div id=\"links\"><a href=\"index.php\">View/create person records</a> | <a href=\"create_new_band.php\">Create a new band record</a> | <a href=\"band.php\">Select a different band</a></div>";
            $display_block .= "<div id=\"text\"><h3 align=\"left\" style=\"color:#FF0000\">Record already exists for $band_name</h4>";
            $display_block .= "<h3 style=\"color:#FF0000\">Record for $band_name - inactive</h3>";
            $display_block .= "<table width=\"300\" border=\"0\" cellspacing=\"5\" cellpadding=\"5\"><tr><td>$band_name <br /><br /><strong>Comments:</strong><br />$band_comment<br /><br />";
        ...
        $display_block .= "<h2 align=\"left\">View/create band records - administrator view</h2>";
        $display_block .= "<div id=\"links\"><a href=\"index.php\">View/create person records</a> | <a href=\"create_new_band.php\">Create a new band record</a> | <a href=\"band.php\">Select a different band</a></div>";
        $display_block .= "<div id=\"text\" align=><h3 align=\"left\">Record created</h3><table width=\"300\" border=\"0\" cellspacing=\"5\" cellpadding=\"5\"><tr><td>" .  stripslashes($band_name) . "<br /><br/><strong>Comments:</strong><br />" . stripslashes($band_comment) . "<br /><br />";        
