...
//This page activates a band record that has been deactivated
...
include("../includes/dbconnect.inc");
    ...
    //set band record to active
    $activate = "UPDATE band SET is_active=1 WHERE id=$band_id";
    ...
    if (mysql_num_rows($get_info_res)> 0)
    {
        ...
        while ($band_info = mysql_fetch_array($get_info_res))
        {
            ...
            $get_list = "SELECT id, CONCAT_WS(', ', lname, fname) as display_name, phone FROM person WHERE is_active=1 ORDER BY lname, fname ASC";
