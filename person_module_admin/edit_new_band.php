...
//This page edits a newly-created band record
...
if (isset($_POST['edit']))
   {
      ...
      if (mysql_num_rows($get_info_res)> 0)
        ...
        //if band record is active display its information
            ...
            $display_block .= "<di<div id=\"text\"><h3 align=\"left\">Record for $band_name - active</h3>";
            ...
            <table><tr><td>
            <form method=\"post\" name=\"person\" action=\"$_SERVER[PHP_SELF]\" onsubmit=\"return validate_form();\">
            <select name=\"sel_id\">
 ...
 if (isset($_POST['add_band_member']))
    ...
    if (mysql_num_rows($get_info_res)> 0)
    {
        ...
        while ($band_info = mysql_fetch_array($get_info_res))
        {
            ...
            $display_block .= "<h2 align=\"left\">View/create band records</h2>";
            $display_block .= "<div id=\"links\"><a href=\"index.php\">View/create person records</a> | <a href=\"create_new_band.php\">Create a new band record</a> | <a href=\"band.php\">Select a different band</a></div>";
            $display_block .= "<div id=\"text\" align=\"left\"><h3 align=\"left\" style=\"color:#FF0000\">Record for $band_name - inactive</h4>";
            $display_block .= "<table width=\"300\" border=\"0\" cellspacing=\"5\" cellpadding=\"5\"><tr><td>$band_name <br /><br /><strong><em>Comments:</em></strong><br />$band_comment<br /><br />";
            $display_block .= "<h3 style=\"color:#FF0000\">Record must be active to add/delete/update band members & contacts</h3> ";
