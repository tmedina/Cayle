...
//This pages deactives a band record
...
//set band record to inactive
$deactivate = "UPDATE band SET is_active=0 WHERE id=$band_id";
...
//get band info
    ...
    if (mysql_num_rows($get_info_res)> 0)
    {
        ...
        while ($band_info = mysql_fetch_array($get_info_res))
        {
            ...
            $display_block .= "<div id=\"text\" align=\"left\"><h3 align=\"left\">Record for $band_name - active</h3>";
            ...
            $display_block .= "<a href=\"deactivate_band.php?band_id=$id\">Deactivate this record</a> | <a href=\"edit_band.php?cmd=edit&id=$band_id\">Edit</a></td></tr></table></div>";
            ...
            <table><tr><td>
            <form method=\"post\" name=\"person\" action=\"add_band_member.php\">
            <select name=\"sel_id\">
            ...
            <td align=\"right\"><a href=\"delete_band_contact.php?person_id=$person_id&band_id=$id\">Remove person as band contact</a> | <a href=\"person_record.php?person_id=$person_id\">View person record</a> | <a href=\"delete_band_member.php?person_id=$person_id&band_id=$id\" onclick=\"return confirm('Are you sure you want to delete this band member?')\">Delete band member</a></td></tr>";
            ...
            {
            $display_block .= "<div id=\"links\"><a href=\"index.php\">View/create person records</a> | <a href=\"create_new_band.php\">Create a new band record</a> | <a href=\"band.php\">Select a different band</a></div>";
            $display_block .="<div id=\"text\" align=\"left\"><h3 align=\"left\" style=\"color:#FF0000\">Record for $band_name - inactive</h3>";
            $display_block .= "<table width=\"300\" border=\"0\" cellspacing=\"5\" cellpadding=\"5\"><tr><td>$band_name <br /><br /><strong><em>Comments:</em></strong><br />$band_comment<br /><br />";
...
?>
 <html>
    <head>
    <title>View/create band records - administrator view</title>
    ...
    <h2 align="left">Band records - administrator view</h2>
    <? Print $display_block; ?>
