...
//This pages show the person record from the search box & band record
 ...
 include("../includes/functions.inc");
    ...
    if (mysql_num_rows($get_info_res)> 0)
    {
        ...
        while ($person_info = mysql_fetch_array($get_info_res))
        {
            ...
            $display_block .= "<strong>User name: </strong>" . $user_name . "<br /><br />";
            $display_block .= "<strong>Comments: </strong>$person_comment";
            $display_block .= "<br /><br /><a href=\"activate_person.php?person_id=$person_id\" onclick=\"return confirm('Are you sure you want to activate this record?')\">Activate</a> | <a href=\"edit.php?cmd=edit&id=$person_id\">Edit</a></td></tr></table>";
