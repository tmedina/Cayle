...
if (!isset($_POST['submit_person']))
    {
            ...
            $display_block .= "
            <h2 align=\"left\">Create a new person record - administrator view</h2>
            ...
            <tr><td>City:</td><td> <input type=\"text\" size=41 name=\"city\" value=\"$city\">&nbsp";
            ...
            $display_block .="</td></tr>
            <tr><td>User name:</td><td> <input type=\"text\" size=50 name=\"user_name\" value=\"$user_name\"></td></tr>
            <tr><td>Password:</td><td> <input type=\"text\" size=50 name=\"password\" value=\"$password\"></td></tr>
            <tr><td valign=\"top\">Comment: </td><td><textarea rows=\"3\" cols=\"38\" name=\"person_comment\"></textarea></td></tr>";

            $display_block .= "<tr><td colspan=2 align=\"center\"><input type=\"reset\" value=\"Clear form\">
            <input type=\"submit\" name=\"submit_person\" value=\"Submit\"></td></tr></table></form>";
...
//create a new person record
 if (isset($_POST['submit_person']))
        ...
        $get_person_info = "SELECT person.id, fname, lname, address, city, state_name, zip, phone, email, person_comment, person_status, person.is_active, user_name FROM person, states, person_status WHERE states.id = person.state_id AND person_status.id = person.person_status_id AND fname = '$fname' AND lname='$lname' AND phone = '$phone'";
        ...
        while ($person_info = mysql_fetch_array($get_person_info_res))
        {
            ...
            //if record is active and has an address do this
            ...
            $display_block .= "<br /><a href=\"band.php\">Add band membership</a> | <a href=\"deactivate_person.php?person_id=$person_id\" onclick=\"return confirm('Are you sure you want to deactivate this record?')\">Deactivate</a> | <a href=\"edit.php?cmd=edit&id=$person_id\">Edit</a></td></tr></table></div>";
            }

            //if record is active and doesn't have an address do this
            ...
            //if record is inactive and has an address to this
            ...
            $display_block .= "<strong>User name: </strong>" . $user_name . "<br /><br />";
            $display_block .= "<strong>Comments: </strong>" . stripslashes($person_comment) . "<br />";            
            $display_block .= "<a href=\"band.php\">Add band membership</a> | <a href=\"activate_person.php?person_id=$person_id\" onclick=\"return confirm('Are you sure you want to activate this record?')\">Activate</a> | <a href=\"edit.php?cmd=edit&id=$person_id\">Edit</a></td></tr></table>";
            ...
            $display_block .= "<br /><h3 style=\"color:#FF0000\">Record must be active to add band membership</h3></div> ";
            }
...

    {
        ...
        $query = ("INSERT INTO person (fname, lname, address, city, state_id, zip, phone, email, person_status_id, person_comment, user_name, password) VALUES ('$fname', '$lname', '$address', '$city', $state_id, '$zip', '$phone', '$email', $person_status_id, '$person_comment', '$user_name', '$encrypted_password')");
        ...
        $display_block .= "<a href=mailto:" . $email . ">" . $email . "</a><br /><br />";
        $display_block .= "<strong>Status:</strong> " . stripslashes($person_status) . "<br /><br />";
        $display_block .= "<strong>User name: </strong>" . $user_name . "<br /><br />";
        ...
        $display_block .= "<h2 align=\"left\">View/create person records - administrator view</h2>";
        $display_block .= "<div id=\"links\"><a href=\"band.php\">View/create band records</a> | <a href=\"create_new_person.php\">Create a new person record</a> | <a href=\"index.php\">Select a different person</a></div>";
        $display_block .= "<div id=\"text\" align=\"left\"><h3>Record created</h3><table width=\"300\" border=\"0\" cellspacing=\"5\" cellpadding=\"5\">";
        $display_block .= stripslashes($fname) . " " . stripslashes($lname) . "<br />" . stripslashes($address) . "<br />";
